#ifndef BUW_RESOURCE_ROBOTO_REGULAR_BINARY_HPP
#define BUW_RESOURCE_ROBOTO_REGULAR_BINARY_HPP

#include <array>

static constexpr std::array<unsigned char, 145348> Roboto_Regular_ttf_binarized {
...
#endif //BUW_RESOURCE_ROBOTO_REGULAR_BINARY_HPP